...
const FlipCard = ({title, backText, frontLogo, backLogo}) => {
  ...
  const combinedStyles = isHovered ? { ...styles.cardStyle, ...styles.hoveredStyles } : styles.cardStyle;

  return (
    <div className='cardStyle' style={combinedStyles}  onClick={handleClick} onMouseEnter={handleMouseEnter}
    onMouseLeave={handleMouseLeave}>
  <div className="innerStyle" style={styles.innerStyle} >
    <div className='frontStyle' style={styles.frontStyle}>
      <div className='background-card' style={styles.background}></div>
    ...
    <div className='backStyle' style={styles.backStyle}>
      ...
      <div className='backText' style={styles.backText}>
        ...
        <div className="backDescription scrollbar-card-back" style={styles.backDescription}>
          {backText}
        </div>
      </div>
    </div>
